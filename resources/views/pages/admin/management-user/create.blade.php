<div class="modal fade" id="createUserManagementModal" tabindex="-1" aria-labelledby="createUserManagementModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('user-management.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="createUserManagementModalLabel">Add User</h5>
