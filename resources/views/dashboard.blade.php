                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                <p class="mb-1 pt-2 text-bold">Sistem Peminjaman Barang</p>
                                <h5 class="font-weight-bolder">Invesapra Dashboard</h5>
                                <p class="mb-5">Anda dapat melihat jumlah peminjaman, status barang yang sedang dipinjam,
                                    serta jumlah karyawan yang terdaftar.
                                </p>
            ...
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                    ...
                    <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                        <h5 class="text-white font-weight-bolder mb-4 pt-2">Kelola Peminjaman Barang</h5>
                        <p class="text-white">Pastikan barang yang dipinjam dan dikembalikan tercatat dengan baik untuk
                            menjaga inventaris tetap terorganisir.
                        </p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('assets/img/inventory.png') }}"
                                                        class="avatar avatar-sm me-3" alt="inventory">
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $inventory->inventory->name }}</h6>
                                                </div>
                                            </div>
                                        </td>
